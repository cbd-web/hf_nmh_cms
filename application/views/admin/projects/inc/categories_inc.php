                        ...
                        <form id="category_add" name="category_add" method="post" action="<?php echo site_url('/');?>project/add_category_project" class="form-inline">
                            <fieldset>
    						<input type="hidden" name="project_id_cat"  value="<?php if(isset($project_id)){echo $project_id;}?>">
                            <div class="input-append span12">
                            <input class="span8"<?php if(!isset($project_id)){echo ' disabled' ;}?> id="appendedInputButtons" type="text" name="category_name" placeholder="Category name..."value="">
						...
						function add_category(){
							...
							if($('#appendedInputButtons').val().length == 0){
								...
								$.ajax({
									type: 'post',
									data: frm.serialize(),
									url: '<?php echo site_url('/').'project/add_category_project';?>' ,
						...
						function delete_category(id){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'project/delete_category_project/';?>'+id ,
									success: function (data) {
						...
						function reload_category(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'project/reload_category_project/'.$project_id;?>' ,
									success: function (data) {
						...
						$(document).ready(function() {
							...
							<?php echo $this->project_model->load_category_typehead();?>
