...
<body>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content" id="curr_cats">
                  	  	<?php $this->admin_model->get_all_enquiries();?>
	...
	<script type="text/javascript">
		...
		$('#modal-enquiry-delete').on('hidden', function () {
			$('#modal-enquiry-delete').unbind('show'); // or $(this)
		});
		...
		$('#modal-view').on('hidden', function () {
			$('#modal-view').unbind('show'); // or $(this)
		});
