		...
		<div id="content" class="span10">
	                            ...
	                            <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="help-block" style="font-size:11px">The URL paramenter. eg: http://www.example.comZabout-us</span> 
                                        </div>
                                    </div>
								  	<div class="control-group">
			...
			<div class="row-fluid sortable">
	        	...
	        	<div class="box span4">
					...
					<div class="box-content">
            			<p><?php $this->admin_model->get_featured_image('recipe', $recipe_id);?></p>                  
          			</div>
				</div>
	        	...
	        	<div class="box span4">
					...
					<div class="box-content">
	            		<button type="button" class="btn btn-inverse btn" onclick="add_ingredient(<?php echo $recipe_id; ?>)">Add Ingredient List</button>
		...
		<form id="ingredient-add" name="ingredient-add" method="post" action="<?php echo site_url('/');?>admin/add_ingredient" class="form-horizontal">
			...
			<fieldset>
                <div class="control-group" id="">
                    ...
                    <input type="text" class="" id="list-title" name="section_title" placeholder="List Title">

                </div>
                <div class="control-group" id="">
                      <input class="" id="ingredient" type="text" name="ingredient" placeholder="Ingredient List Item" value="">
                      <button class="btn btn-inverse btn" id="ing-butt" type="button"><i class="icon-plus-sign icon-white"></i> Add Ingredient</button>
                </div>			
				<button class="btn btn-primary btn-large btn-block" id="ing-sub-butt" type="button"><i class="icon-plus-sign icon-white"></i> Submit List</button>
			</fieldset>
		</form>
	</div>
	<div class="modal-footer">
