...
<body>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	  	<p>
							<form id="map-add" name="map-add" method="post" action="<?php echo site_url('/');?>map/add_map_do" class="form-horizontal">
                             <fieldset>
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Map</button>
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'map/add_map_do';?>' ,
