...
<body>
		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>itinerary/highlights/">Highlights</a><span class="divider">/</span>
					</li>
                    <li>
						Update Highlights: <?php echo $title;?>
					</li>
				</ul>
				<hr>
			</div>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span> Update Highlight: <?php echo $title;?></h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="highlight-update" name="highlight-update" method="post" action="<?php echo site_url('/');?>itinerary/update_highlight_do" class="form-horizontal">
                             <fieldset>
								<input type="hidden" name="id" value="<?php if(isset($highlight_id)){echo $highlight_id;}?>">
								...
								<input type="hidden" name="status" id="status"  value="<?php if(isset($status)){echo $status;}?>">
								  ...
								  <div class="control-group">
									...
									<div class="controls">
											<input type="text" class="span6" id="title" name="title" placeholder="Highlight title" value="<?php if(isset($title)){echo $title;}?>">
									</div>
								  </div>
								  ...
								  <div class="control-group">
									...
									<div class="controls">
										<select name="type">
											<option value="0">Choose a Highlight type</option>
											<?php echo $this->itinerary_model->get_high_type_select($type_id); ?>
										</select>
									</div>
								  </div>																																													  
								  ...
								  <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Update Highlight</button>
                ...
                <div class="box span6">
					...
					<div class="box-content">
                         ...
                         <div id="gallery_images">   
                            <?php $this->itinerary_model->load_images_update('highlight', $highlight_id);?>
                        </div>
	...
	function submit_form(){
		...
		var frm = $('#highlight-update');
		//frm.submit();
		$('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
		$.ajax({
			type: 'post',
			data: frm.serialize(),
			url: '<?php echo site_url('/').'itinerary/update_highlight_do';?>' ,
			success: function (data) {
				 $('#autosave').val('true');
				 $('#result_msg').html(data);
				 $('#butt').html('Update Highlight');
	...
	window.onbeforeunload = function() {		 
		 if($('#autosave').val() == 'false'){
			return 'The highlight has not been saved.';
		 }
	};
	...
	$(function() {
		...
		<?php //$info = $this->itinerary_model->get_images('highlight', $highlight_id); ?>
		...
		$("#uploader").pluploadQueue({
			...
			chunk_size : '1mb',
			unique_names : true,
			multipart_params: {type_id : '<?php echo $highlight_id; ?>',type : 'highlight'},
	...
	function load_images(){
		  ...
		  $.ajax({
			cache: false,
			method: "post",  
			url: "<?php echo site_url('/');?>itinerary/load_images_update/highlight/<?php echo $highlight_id; ?>/<?php echo rand(0,9999);?>",
			success: function(data) {
