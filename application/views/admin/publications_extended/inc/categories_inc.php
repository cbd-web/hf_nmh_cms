                        ...
                        <form id="category_add" name="category_add" method="post" action="<?php echo site_url('/');?>publication_extended/add_category_pub" class="form-inline">
                            <fieldset>
						...
						function add_category(){
							...
							if($('#appendedInputButtons').val().length == 0){
								...
								$.ajax({
									type: 'post',
									data: frm.serialize(),
									url: '<?php echo site_url('/').'publication_extended/add_category_pub';?>' ,
						...
						function delete_category(id){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'publication_extended/delete_category_pub/';?>'+id ,
									success: function (data) {
						...
						function reload_category(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'publication_extended/reload_category_pub/'.$pub_id;?>' ,
									success: function (data) {
