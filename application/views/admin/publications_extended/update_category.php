		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>publication_extended/publications/">Pulications</a><span class="divider">/</span>
					</li>
					<li>
						<a href="<?php echo site_url('/');?>publication_extended/categories/">Categories</a><span class="divider">/</span>
					</li>
                    <li>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	  	<p>
							<form id="cat-update" name="cat-update" method="post" action="<?php echo site_url('/');?>publication_extended/update_category_do" class="form-horizontal">
                             <fieldset>
...
//				$('#redactor_content_msg').focus();		
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'publication_extended/update_category_do';?>' ,
