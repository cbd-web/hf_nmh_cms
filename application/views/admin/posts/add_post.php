...
<body>
                ...
                <div class="row-fluid sortable">
                    ...
                    <div class="box span8">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span>Add New Post</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <p>
                            <form id="page-update" name="page-update" method="post"
                                action="<?php echo site_url('/');?>admin/add_post_do" class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="help-block" style="font-size:11px">Optional, give your page a
                                                sub heading (h2)</span>
                                        </div>
                                    </div>

                                    <?php echo $this->admin_model->get_post_lang_option(); ?>

                                    <div class="control-group">
                                        <label class="control-label" for="slug">Slug</label>
                                        <div class="controls">
                                            <input type="text" class="span6" id="slug" name="slug"
                                                placeholder="Post URL Slug eg: /about-us" value="">
                                        </div>
                                    </div>
    ...
    function submit_form() {
        ...
        $.ajax({
            type: 'post',
            data: data,
            url: '<?php echo site_url('/').'admin/add_post_do';?>',
