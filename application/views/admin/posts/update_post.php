...
<body>
            ...
            <div id="content" class="span10">
                ...
                <div class="row-fluid sortable">
                    ...
                    <div class="box span12">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span> Update Post: <?php echo $title; ?>
                            </h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <p>
                            <form id="post-update" name="post-update" method="post"
                                action="<?php echo site_url('/'); ?>admin/update_post_do" class="form-horizontal">
                                <fieldset>
                                    <input type="hidden" name="post_id" value="<?php if (isset($post_id)) {
                                        echo $post_id;
                                    } ?>">
                                    ...
                                    <input type="hidden" name="comments" id="comments" value="<?php if (isset($comments)) {
                                        echo $comments;
                                    } ?>">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="title" name="title"
                                                placeholder="Post title" value="<?php if (isset($title)) {
                                                    echo $title;
                                                } ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="btn-group" data-toggle="buttons-radio">
                                                <button type="button" class="btn btn-primary status<?php if ($status == 'draft') {
                                                    echo ' active';
                                                } ?>">Draft</button>
                                                <button type="button" class="btn btn-primary status<?php if ($status == 'live') {
                                                    echo ' active';
                                                } ?>">Live</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="btn-group" data-toggle="buttons-radio">
                                                <button type="button" class="btn btn-primary comments<?php if ($comments == 'allow') {
                                                    echo ' active';
                                                } ?>">Allow</button>
                                                <button type="button" class="btn btn-primary comments<?php if ($comments == 'no') {
                                                    echo ' active';
                                                } ?>">No</button>
                                                <button type="button" class="btn btn-primary comments<?php if ($comments == 'private') {
                                                    echo ' active';
                                                } ?>">Private</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="heading" name="heading"
                                                placeholder="Post Heading" value="<?php if (isset($heading)) {
                                                    echo $heading;
                                                } ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="slug" name="slug"
                                                placeholder="Post URL Slug eg: /about-us" value="<?php if (isset($slug)) {
                                                    echo $slug;
                                                } ?>">
                                        </div>
                                    </div>

                                    <div class="control-group" id="tinymce_msg">
                                        <label class="control-label" for="tinymce">Post Body:</label>
                                        <div class="controls">

                                            <textarea class="tinymce postBody" name="content" id="tinymce"><?php echo str_replace("cms2.my.na", "d3rp5jatom3eyn.cloudfront.net/cms", $body); ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <!-- 								 		<div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                             <div class="input-append date" id="dob" data-date="<?php if (isset($datetime)) {
                                                                 echo date('Y-m-d', strtotime($datetime));
                                                             } else {
                                                                 echo date();
                                                             } ?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                                              <input type="text"  name="pub_date" id="pub_date" value="<?php if (isset($datetime)) {
                                                                  echo date('Y-m-d', strtotime($datetime));
                                                              } else {
                                                                  echo date();
                                                              } ?>" readonly>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="help-block" style="font-size:11px">Select the date the post
                                                is published</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="metaT" style="display:block" class="span6 metaT"><?php if (isset($metaT)) {
                                                echo $metaT;
                                            } ?></textarea>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="metaT">Meta Keywords:</label>
                                        <div class="controls">
                                            <textarea name="metaK" style="display:block" class="span6 metaK"><?php if (isset($metaK)) {
                                                echo $metaK;
                                            } ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="metaD" style="display:block" class="span6 metaD"><?php if (isset($metaD)) {
                                                echo $metaD;
                                            } ?></textarea>
                                            <span class="help-block" style="font-size:11px">This is an invisible tag
                                                ...
                                                characters. Must be unique to any onther post.</span>
                                        </div>
                                        <style>
                                    ...
                                    <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Update
                                        Post</button>
                                    <a href="<?php echo $this->session->userdata('url'); ?>/post/<?php echo $slug; ?>/"
                                        target="_blank" style="margin: 0px 10px" class="btn pull-right btn-inverse"><i
                                            class="icon-search icon-white"></i> Preview</a>
                                    <button class="btn btn-inverse AmitSahoo45-button-3 pull-right aiBtn"> <img
                                            src="<?= site_url('assets/images/ai-stars.png') ?>" alt="">
                                        Complete using AI</button>
                                </fieldset>
                            </form>
                            </p>
                        </div>
                ...
                <div class="row-fluid sortable">
                    ...
                    <div class="box span4">
                        ...
                        <div class="box-content">
                            <div class="alert">
                                This is the secondary smaller post column. Please select what component you would like
                                to display.
                            </div>
                            <p>
    ...
    <script type="text/javascript" src="<?php echo base_url('/') ?>admin_src/js/bootstrap-datetimepicker.min.js">
    </script>
    <script type="text/javascript">
        ...
        $('#butt').bind('click', function (e) {
            ...
            if ($('#title').val().length == 0) {
                ...
                $('#title').popover({
                    ...
                    content: "Please supply us with a post title"
                });
                $('#title').popover('show');
                $('#title').focus();
                /*		
        ...
        function attach_gallery() {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/') . 'admin/update_sidebar/post/' . $post_id . '/gallery/'; ?>' +
                    gal_id,
        ...
        function remove_gallery(gal_id) {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/') . 'admin/remove_sidebar/post/' . $post_id . '/gallery/'; ?>' +
                    gal_id,
                success: function (data) {
        ...
        aiBtn.addEventListener('click', (e) => {
            ...
            $('.aiBtn').html(
                '<img src="<?= site_url('assets/images/ai-stars-working.gif') ?>" /> Working...');

            $(".aiBtn").attr("disabled", true);

            $.ajax({
                type: 'post',
                dataType: "json",
                data: {
                    body: tinymce.get('tinymce').getContent({ format: 'text' }),
                    type: 'post'
                },
                url: '<?php echo site_url('/') . 'admin/ai_collaboration'; ?>',
                success: function (data) {
                    if (data.status) {
                        $(".metaK").val(data.metaKeywords);
                        $(".metaD").val(data.metaDescription);
                    }
                    $('#result_msg').html(data.popover);

                    $('.aiBtn').html(
                        '<img src="<?= site_url('assets/images/ai-stars.png') ?>" /> Supplement using AI'
                    );

                    $(".aiBtn").attr("disabled", false);
                }
            });
        })
    </script>
