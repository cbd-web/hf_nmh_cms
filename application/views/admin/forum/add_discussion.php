			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Discussion</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="discussion-update" name="discussion-update" method="post" action="<?php echo site_url('/');?>forum/add_discussion_do" class="form-horizontal">
                             <fieldset>
    
                                          <div class="control-group">
                                            <label class="control-label" for="title">Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Discussion title" value="">
                                            </div>
                                          </div>
                             			  <div class="control-group">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="slug" name="slug" placeholder="Discussion URL Slug eg: /about-us" value="">  
                                            </div>
                                          </div>
                            										  
											<?php print $this->forum_model->parent_discussion_list();?>									  
                            
							
                                          <div class="control-group">
                                            <label class="control-label" for="sequence">Sequence:</label>
                                            <div class="controls">
                                                    <input name="discussion_sequence" type="text" class="span1" id="sequence" value="0" size="3" maxlength="3">  
                                            </div>
                                 		  </div>
                                          
                                           <?php $this->forum_model->get_discussion_templates($forum_template = '');?> 
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Discussion</button>
...
/*		}else if($('#redactor_content').val() == 0){
	...
	function submit_form(){
			...
			var frm = $('#discussion-update');
			//frm.submit();
			$('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'forum/add_discussion_do';?>' ,
				success: function (data) {
					
					 $('#result_msg').html(data);
					 $('#butt').html('Add Discussion');
