			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content" id="curr_cats">
                  	  	<?php $this->vendor_model->get_all_categories();?>
                ...
                <div class="box span4 noMargin" onTablet="span12" onDesktop="span4">
					...
					<div class="box-content">
					 <div class="clearfix" style="height:20px;"></div> 
                       <form id="category_add" name="category_add" method="post" action="<?php echo site_url('/');?>vendor/add_category" class="form-inline">
                             <fieldset>                      
			...
			$('#modal-category-delete').bind('show', function() {
				//var id = $(this).data('id'),
					...
					removeBtn.unbind('click').click(function(e) { 
						e.preventDefault();	
						$.ajax({
						  url: "<?php echo site_url('/');?>vendor/delete_category/"+id+"/",
						...
						function add_category(){
							...
							if($('#appendedInputButtons').val().length == 0){
								...
								$.ajax({
									type: 'post',
									data: frm.serialize(),
									url: '<?php echo site_url('/').'vendor/add_category';?>' ,
									success: function (data) {
						...
						function reload_category(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'vendor/reload_category_all/';?>' ,
									success: function (data) {
						...
						$(document).ready(function() {
							...
							<?php echo $this->vendor_model->load_category_typehead();?>
