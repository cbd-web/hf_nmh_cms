...
<body>
            ...
            <div id="content" class="span10">
                ...
                <div>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            Update Member: <?php echo $company; ?>
                        </li>
                    </ul>
                    <hr>
                </div>
                ...
                <div class="row-fluid sortable">
                    ...
                    <div class="box span8">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span> Update member:
                                <?php echo $company; ?>
                            </h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            ...
                            <form id="member-update" name="member-update" method="post"
                                action="<?php echo site_url('/'); ?>member/update_member_do" class="form-horizontal">
                                <fieldset>
                                    <input type="hidden" name="member_id" value="<?php if (isset($member_id)) {
                                        echo $member_id;
                                    } ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="title" name="title"
                                                placeholder="Company Name" value="<?php if (isset($title)) {
                                                    echo $title;
                                                } ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="middle_name" name="middle_name"
                                                placeholder="Middle Name" value="<?php if (isset($middle_name)) {
                                                    echo $middle_name;
                                                } ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="type" name="type"
                                                placeholder="Firm type" value="<?php if (isset($type)) {
                                                    echo $type;
                                                } ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="membership_number"
                                                name="membership_number" placeholder="Firm membership_number" value="<?php if (isset($membership_number)) {
                    ...
                    <div class="box span4">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span>Member Sidebar</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="alert">
                                This is the secondary smaller member column. Please select what component you would
                                like to display.
                            </div>
                            <p>
                    ...
                    <div class="box span4">
                        ...
                        <div class="box-content">
                            <p>
                                ...
                                <?php $this->admin_model->get_featured_image('member', $member_id); ?>
    ...
    $(document).ready(function() {
        ...
        $('#member-update :input').change(function() {
    ...
    function submit_form() {
        ...
        $.ajax({
            ...
            data: frm.serialize(),
            url: '<?php echo site_url('/') . 'member/update_member_do'; ?>',
