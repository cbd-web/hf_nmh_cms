...
<body>
            ...
            <div id="content" class="span10">
                ...
                <div>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo site_url('/'); ?>accountant/accountants/">Accountants</a><span
                                class="divider">/</span>
                        </li>
                        <li>
                            Update Accountant: <?php echo $company; ?>
                        </li>
                    </ul>
                    <hr>
                </div>
                ...
                <div class="row-fluid sortable">
                    ...
                    <div class="box span8">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span> Update accountant:
                                <?php echo $company; ?>
                            </h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <p>
                            <form id="accountant-update" name="accountant-update" method="post"
                                action="<?php echo site_url('/'); ?>accountant/update_accountant_do"
                                class="form-horizontal">
                                <fieldset>
                                    <input type="hidden" name="accountant_id" value="<?php if (isset($accountant_id)) {
                                        echo $accountant_id;
                                    } ?>">
                    ...
                    <div class="box span4">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span>Accountant Sidebar</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="alert">
                                This is the secondary smaller accountant column. Please select what component you would
                                like to display.
                            </div>
                            <p>
                    ...
                    <div class="box span4">
                        ...
                        <div class="box-content">
                            <p>
                                ...
                                <?php $this->admin_model->get_featured_image('accountant', $accountant_id); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#butt').bind('click', function (e) {
                ...
                if ($('#company').val().length == 0) {
                    ...
                    $('#company').popover({
                        ...
                        content: "Please supply us with a accountant title"
                    });
            ...
            $('#accountant-update :input').change(function () {
        ...
        function submit_form() {
            ...
            $.ajax({
                ...
                data: frm.serialize(),
                url: '<?php echo site_url('/') . 'accountant/update_accountant_do'; ?>',
                success: function (dataresult) {
                    $('#autosave').val('true');
                    $('#result_msg').html(dataresult);
                    $('#butt').html('Update accountant');
        ...
        window.onbeforeunload = function () {
            ...
            if ($('#autosave').val() == 'false') {
                return 'The accountant has not been saved.';
