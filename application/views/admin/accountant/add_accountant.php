                ...
                <div class="row-fluid sortable">
                    ...
                    <div class="box span8">
                        <div class="box-header">
                            <h2><i class="icon-th"></i><span class="break"></span>Add New Accountant</h2>
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            ...
                            <form id="accountant-update" name="accountant-update" method="post"
                                action="<?php echo site_url('/'); ?>accountant/add_accountant_do"
    ...
    <script type="text/javascript">
        ...
        function submit_form() {
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/') . 'accountant/add_accountant_do'; ?>',
                success: function (data) {

                    $('#result_msg').html(data);
                    $('#butt').html('Add accountant');
