			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>All Product Categories</h2>
						<div class="box-icon">
							<a href="#" class="btn-close"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content" id="curr_cats">
                  	  	<?php $this->product_model->get_all_categories();?>
                ...
                <div class="box span4 noMargin" onTablet="span12" onDesktop="span4">
					...
					<div class="box-content">
					 <div class="clearfix" style="height:20px;"></div> 
                       <form id="category_add" name="category_add" method="post" action="<?php echo site_url('/');?>product/add_category_do" class="form-inline">
                             <fieldset>                        
                            <div class="span12">
							  ...
							  <div id="curr_parents">
								...
								<?php echo $this->product_model->get_category_list(); ?>
			...
			$('#modal-category-delete').bind('show', function() {
				//var id = $(this).data('id'),
					...
					removeBtn.unbind('click').click(function(e) { 
						e.preventDefault();	
						$.ajax({
						  url: "<?php echo site_url('/');?>product/delete_category/"+id+"/",
						...
						function add_category(){
							...
							if($('#appendedInputButtons').val().length == 0){
								...
								$.ajax({
									type: 'post',
									data: frm.serialize(),
									url: '<?php echo site_url('/').'product/add_category';?>' ,
									success: function (data) {
						...
						function reload_category(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'product/reload_category_all/';?>' ,
									success: function (data) {
						...
						function reload_parent(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'product/reload_parent_all/';?>' ,
									success: function (data) {
										
										 $('#curr_parents').html(data);
						...
						$(document).ready(function() {
							...
							<?php echo $this->product_model->load_category_typehead();?>
