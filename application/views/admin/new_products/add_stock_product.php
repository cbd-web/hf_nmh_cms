...
<body>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Stock Product</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="product-update" name="product-update" method="post" action="<?php echo site_url('/');?>product/add_stock_product_do" class="form-horizontal">
                             <fieldset>
										  ...
										  <div class="control-group">
                                            <label class="control-label" for="category">Product</label>
                                            <div class="controls">
												<select name="product_id">
												<option value="0">Select a Product</option>
													<?php echo $this->product_model->get_product_list(); ?>
												</select>
                                            </div>
                                          </div>									  
                                         ...
                                         <div class="control-group">
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Stock Product</button>
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'product/add_stock_product_do';?>' ,
