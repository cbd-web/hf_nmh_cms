			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	<?php $this->product_model->get_all_products();?>
                ...
                <div class="box span4 noMargin" onTablet="span12" onDesktop="span4">
					...
					<a href="<?php echo site_url('/');?>product/add_product/" class="btn btn-inverse"><i class="fa-icon-plus-sign"></i> Add New Product</a> 
					</div>
				</div><!--/span-->
