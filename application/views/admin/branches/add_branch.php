			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Branch</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="branch-update" name="branch-update" method="post" action="<?php echo site_url('/');?>branch/add_branch_do" class="form-horizontal">
                             <fieldset>
    
                                          <div class="control-group">
                                            <label class="control-label" for="title">Branch Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Branch title" value="">
                                            </div>
                                          </div>
                                          <div class="control-group">
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Branch</button>
...
/*		}else if($('#redactor_content').val() == 0){
	...
	function submit_form(){
			...
			var frm = $('#branch-update');
			//frm.submit();
			$('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'branch/add_branch_do';?>' ,
				success: function (data) {
					
					 $('#result_msg').html(data);
					 $('#butt').html('Add Branch');
