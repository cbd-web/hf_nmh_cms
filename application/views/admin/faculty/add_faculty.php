...
<body>
		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>faculty/faculties/">Faculties</a><span class="divider">/</span>
					</li>
                    <li>
						Add New Faculty
					</li>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Faculty</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="faculty-update" name="faculty-update" method="post" action="<?php echo site_url('/');?>faculty/add_faculty_do" class="form-horizontal">
                             <fieldset>
    
                                          <div class="control-group">
                                            <label class="control-label" for="title">Faculty Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Faculty title" value="">
                                            </div>
                                          </div>
                                          <div class="control-group">
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Faculty</button>
	...
	$('#butt').click(function(e) {
		...
		if($('#title').val().length == 0){
				...
				$('#title').popover({  delay: { show: 100, hide: 3000 },placement:"top",html: true,trigger: "manual", title:"Title Required", content:"Please supply us with a faculty title"});
				$('#title').popover('show');
				$('#title').focus();
...
/*		}else if($('#redactor_content').val() == 0){
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'faculty/add_faculty_do';?>' ,
				success: function (data) {
					
					 $('#result_msg').html(data);
					 $('#butt').html('Add faculty');
