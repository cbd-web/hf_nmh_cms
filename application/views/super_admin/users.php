	...
	<div class="container-fluid">
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content" id="curr_cats">
                  	  	<?php $this->super_admin_model->get_all_users();?>
                ...
                <div class="box span4 noMargin" onTablet="span12" onDesktop="span4">
                    ...
                    <a onClick="add_sys_user()" class="btn btn-inverse"><i class="fa-icon-plus-sign"></i> Add New User</a> 
		    		</div>
				</div><!--/span-->
		...
		<div class="modal hide fade" id="modal-add">
          ...
          <div class="modal-body">
            <form id="user-add" name="user-add" method="post" action="<?php echo site_url('/');?>admin/add_sys_user_do" class="form-horizontal">
        ...
        <div class="modal hide fade" id="modal-update">
          ...
          <div class="modal-footer">
            ...
            <a onClick="update_sys_user_do()" id="update_user_btn" class="btn btn-primary">Update user</a>
          </div>
        </div>
			...
			$('#modal-user-delete').bind('show', function() {
				//var id = $(this).data('id'),
					...
					removeBtn.unbind('click').click(function(e) { 
						e.preventDefault();	
						$.ajax({
						  url: "<?php echo site_url('/');?>admin/delete_user/"+id+"/",
				...
				function add_sys_user(){
						...
						$('#modal-add').bind('show', function() {
								...
								removeBtn.unbind('click').click(function(e) { 
									...
									$.ajax({
									  type: "post",
									  data: frm.serialize(),
									  url: "<?php echo site_url('/');?>admin/add_sys_user_do",
									  success: function(data) {
					...
					function update_sys_user(id){
						...
						$('#modal-update').bind('show', function() {
									...
									$.ajax({
									  type: "get",
									  url: "<?php echo site_url('/');?>admin/get_sys_user/"+id,
									  success: function(data) {
					...
					function update_sys_user_do(){
							  ...
							  $.ajax({
								type: "post",
								data: frm.serialize(),
								url: "<?php echo site_url('/');?>admin/update_sys_user_do",
								success: function(data) {
