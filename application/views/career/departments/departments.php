...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Departments</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a class="btn btn-primary btn-lg pull-right" href="<?php echo site_url('/') ?>career/add_department"><i class="glyphicon glyphicon-plus"></i> ADD NEW DEPARTMENT</a>
            </div>
        </div>
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_dep">
                            <?php $this->career_model->get_all_departments(); ?>
                            </div>
...
<script type="text/javascript">
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_department_bulk/'+bulk,
    ...
    $(document).ready(function() {
        ...
        function reload_departments(){
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_departments_all/' ;?>' ,
                success: function (data) {
    ...
    function delete_department(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_department_do/"+id+"/",
                    success: function(data) {
                        reload_departments();
