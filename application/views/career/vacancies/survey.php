...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>MR Survey</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a class="btn btn-primary btn-lg pull-right" href="<?php echo site_url('/') ?>career/add_vacancy_survey"><i class="glyphicon glyphicon-plus"></i> ADD NEW SURVEY</a>
            </div>
        </div>
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_sur">
                            <?php $this->career_model->get_all_vacancy_surveys(); ?>
                            </div>
...
<script type="text/javascript">
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_vacancy_survey_bulk/'+bulk,
    ...
    $(document).ready(function() {
        ...
        function reload_surveys(){

            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_vacancy_surveys_all/' ;?>' ,
                success: function (data) {
    ...
    function delete_survey(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_vacancy_survey_do/"+id+"/",
                    success: function(data) {
                        reload_surveys();
