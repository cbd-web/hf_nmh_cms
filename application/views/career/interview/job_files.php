...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Job Files</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a class="btn btn-primary btn-lg pull-right" href="<?php echo site_url('/') ?>career/add_job_file"><i class="glyphicon glyphicon-plus"></i> ADD NEW FILE</a>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form action="" method="post" id="action_multi_files" class="form">
                                <div  id="curr_jobs">
                                    <?php $this->career_model->get_all_job_files(); ?>
                                </div>
...
<script type="text/javascript">
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_job_files_bulk/'+bulk,
    ...
    function delete_file(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_job_file_do/"+id+"/",
                    success: function(data) {
                        reload_files();
    ...
    function reload_files(){
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo site_url('/').'career/reload_job_files_all/' ;?>' ,
            success: function (data) {
