...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Automated Messages</li>
        </ol>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark">
                    ...
                    Automated Messages
                    <span>&gt;
                        List of all automated messages
                    </span>
                </h1>
            </div>

            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <a class="btn btn-primary btn-lg pull-right" href="<?php echo site_url('/') ?>career/add_message"><i class="glyphicon glyphicon-plus"></i> ADD NEW MESSAGE</a>
            </div>
        </div>
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_msg">
                            <?php $this->career_model->get_all_messages(); ?>
                            </div>
...
<script type="text/javascript">
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_message_bulk/'+bulk,
    ...
    $(document).ready(function() {
        ...
        function reload_messages(){
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_messages_all/' ;?>' ,
                success: function (data) {
    ...
    function delete_department(id, title){

        $.SmartMessageBox({
            title : "<span style='color:#c00; font-weight:bold'>Delete Entry: "+title+"</span>",
            content : "The entry will be deleted permanently! Click <strong><u>YES</u></strong> to Delete entry. Click <strong><u>NO</u></strong> to Cancel.",
            buttons : '[No][Yes]'
        }, function(ButtonPressed) {
            if (ButtonPressed === "Yes") {

                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_message_do/"+id+"/",
                    success: function(data) {
                        reload_messages();
