...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Locations</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                ...
                <div class="well">
                    <form name="add-location" id="add-location" method="post" action="<?php echo site_url('/') ?>career/add_location_do" enctype="multipart/form-data">
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                <button class="btn btn-default btn-primary" type="submit" id="butt">
                                    <i class="fa fa-plus"></i> Add Locations
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_locs">
                            <?php $this->career_model->get_all_locations(); ?>
                            </div>
...
<script type="text/javascript">
    ...
    $('#butt').click(function(e) {
        ...
        if($('#location').val().length == 0){
            ...
            $('#location').popover({  delay: { show: 100, hide: 3000 },placement:"top",html: true,trigger: "manual", title:"Location Required", content:"Please supply us with a location"});
            ...
            var frm = $('#add-location');
            //frm.submit();
            $('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/add_location_do';?>' ,
    ...
    function bulk_action(bulk){
        ...
        if(bulk == 1) {
            ...
            var title = "<span style='color:#c00; font-weight:bold'>Delete Location Entries</span>";
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_location_bulk/'+bulk,
                    success: function(data) {
    ...
    $(document).ready(function() {
        ...
        function reload_locations(){
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_locations_all/' ;?>' ,
                success: function (data) {
    ...
    function delete_location(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_location_do/"+id+"/",
                    success: function(data) {
                        reload_locations();
