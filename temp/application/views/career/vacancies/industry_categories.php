...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Industry Categories</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                ...
                <div class="well">
                    <form name="add-category" id="add-category" method="post" action="<?php echo site_url('/') ?>career/add_industry_category" enctype="multipart/form-data">
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_vac">
                            <?php $this->career_model->get_all_industry_categories(); ?>
                            </div>
...
<script type="text/javascript">
    ...
    $('#butt').click(function(e) {
        ...
        if($('#category').val().length == 0){
            ...
            $('#category').popover({  delay: { show: 100, hide: 3000 },placement:"top",html: true,trigger: "manual", title:"Category Required", content:"Please supply us with a category"});
            ...
            var frm = $('#add-category');
            //frm.submit();
            $('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/add_industry_cat_do';?>' ,
    ...
    function bulk_action(bulk){
        ...
        if(bulk == 1) {
            ...
            var title = "<span style='color:#c00; font-weight:bold'>Delete Industry Category Entry?</span>";
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_industry_cat_bulk/'+bulk,
                    success: function(data) {
    ...
    function delete_industry(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_industry_cat_do/"+id+"/",
                    success: function(data) {
                        reload_industries();
    ...
    function reload_industries(){

        $.ajax({
            type: 'get',
            url: '<?php echo site_url('/').'career/reload_industry_cat_all/' ;?>' ,
            success: function (data) {
