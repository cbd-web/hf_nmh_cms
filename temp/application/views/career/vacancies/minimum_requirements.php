...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Minimum Requirement Categories</li>
        </ol>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h1 class="page-title txt-color-blueDark">
                    ...
                    <span>&gt;
                        List of all MR Categories
                    </span>
                </h1>

                <div class="well">
                    <form name="add-mr" id="add-mr" method="post" action="<?php echo site_url('/') ?>career/add_mr_do" enctype="multipart/form-data">
                        <div class="input-group">
                            <input class="form-control" type="text" name="mr" id="mr" placeholder="Enter Category...">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <header>
                        ...
                        <h2>All MR Categories Listed</h2>
                    </header>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_disc">
                            <?php $this->career_model->get_all_mr(); ?>
                            </div>
...
<script type="text/javascript">
    ...
    $('#butt').click(function(e) {
        ...
        if($('#mr').val().length == 0){
            ...
            $('#mr').popover({  delay: { show: 100, hide: 3000 },placement:"top",html: true,trigger: "manual", title:"MR Required", content:"Please supply us with a MR Title"});
            $('#mr').popover('show');
            $('#mr').focus();
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/add_mr_do';?>' ,
                success: function (data) {
                    ...
                    $('#butt').html('<i class="fa fa-plus"></i> Add Minimum Requirement');
                    reload_mr();
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_mr_bulk/'+bulk,
                    success: function(data) {
    ...
    $(document).ready(function() {
        ...
        function reload_mr(){
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_mr_all/' ;?>' ,
                success: function (data) {
    ...
    function delete_mr(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_mr_do/"+id+"/",
                    success: function(data) {
                        reload_mr();
