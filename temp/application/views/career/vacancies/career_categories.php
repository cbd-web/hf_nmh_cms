...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Career Categories</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                ...
                <div class="well">
                    <form name="add-category" id="add-category" method="post" action="<?php echo site_url('/') ?>career/add_career_category" enctype="multipart/form-data">
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_vac">
                            <?php $this->career_model->get_all_career_categories(); ?>
                            </div>
...
<script type="text/javascript">
    ...
    $('#butt').click(function(e) {
        ...
        if($('#category').val().length == 0){
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/add_career_cat_do';?>' ,
    ...
    function bulk_action(bulk){
        ...
        if(bulk == 1) {
            ...
            var title = "<span style='color:#c00; font-weight:bold'>Delete Career Category Entries</span>";
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_career_cat_bulk/'+bulk,
                    success: function(data) {
    ...
    $(document).ready(function() {
        ...
        function reload_careers(){

            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_career_cat_all/' ;?>' ,
                success: function (data) {
    ...
    function delete_career(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_career_cat_do/"+id+"/",
                    success: function(data) {
                        reload_careers();
