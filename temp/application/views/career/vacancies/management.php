...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li>Management Levels</li>
        </ol>
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                ...
                <div class="well">
                    <form name="add-level" id="add-level" method="post" action="<?php echo site_url('/') ?>career/add_management_do" enctype="multipart/form-data">
                        <div class="input-group">
                            <input class="form-control" type="text" name="level" id="level" placeholder="Level Name...">
                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <div  id="curr_levels">
                            <?php $this->career_model->get_all_management(); ?>
                            </div>
...
<script type="text/javascript">
    ...
    $('#butt').click(function(e) {
        ...
        if($('#level').val().length == 0){
            ...
            $('#level').popover({  delay: { show: 100, hide: 3000 },placement:"top",html: true,trigger: "manual", title:"Level Required", content:"Please supply us with a level"});
            $('#level').popover('show');
            $('#level').focus();
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/add_management_do';?>' ,
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    type: 'post',
                    data: frm.serialize(),
                    url: '<?php echo site_url('/') ?>career/action_management_bulk/'+bulk,
                    success: function(data) {
    ...
    $(document).ready(function() {
        ...
        function reload_levels(){

            $.ajax({
                type: 'get',
                url: '<?php echo site_url('/').'career/reload_management_all/' ;?>' ,
                success: function (data) {

                    $('#curr_levels').html(data);
                    /* BASIC ;*/
                    var responsiveHelper_dt_basic = undefined;
                    var responsiveHelper_datatable_fixed_column = undefined;
                    var responsiveHelper_datatable_col_reorder = undefined;
    ...
    function delete_level(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_management_do/"+id+"/",
                    success: function(data) {
                        reload_levels();
