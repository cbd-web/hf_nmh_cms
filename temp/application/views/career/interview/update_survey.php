...
<div id="main" role="main">
    ...
    <div id="ribbon">
        ...
        <!-- breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('/'); ?>career">Home</a></li><li><a href="<?php echo site_url('/'); ?>career/interview_survey">Interview Survey</a></li><li>Update Survey</li>
        </ol>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark">
                    ...
                    INTERVIEW SURVEY
                    <span>&gt;
                        Update Interview Survey: <strong><?php echo $title; ?></strong>
                    </span>
                </h1>
            </div>
                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-0" role="widget">
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body">
                            <form id="survey-update" name="survey-update" method="post" action="<?php echo site_url('/');?>career/update_interview_survey_do" class="smart-form">
        ...
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-editbutton="false" role="widget" style="">
                    ...
                    <header>
                        &nbsp;<h2><i class="fa fa-lg fa-fw fa-question"></i> SURVEY QUESTIONS</h2>
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body">
                            ...
                            <button data-toggle="modal" data-target="#myQuestion" class="btn btn-info">ADD QUESTION</button>
                            <form action="" method="post" id="action_multi_files" class="form">
                                ...
                                <div class="row-fluid" id="question_div">
                                    ...
                                    <?php echo $this->career_model->interview_survey_questions($survey_id); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="survey_question_add" class="smart-form" method="post" action="<?php echo site_url('/');?>career/add_interview_survey_question_do">
                    <input type="hidden" name="survey_id"  value="<?php if(isset($survey_id)){echo $survey_id;}?>">
                    <div class="row-fluid">
                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function update_question(id){
        ...
        $.ajax({
            url: "<?php echo site_url('/');?>career/update_interview_survey_question/"+id+"/",
            ...
            if (ButtonPressed === "Yes") {
                ...
                if(bulk == 1) {
                    ...
                    $.ajax({
                        type: 'post',
                        data: frm.serialize(),
                        url: '<?php echo site_url('/') ?>career/action_interview_survey_questions_bulk/'+bulk,
                        success: function(data) {
    ...
    $('#butt').click(function(e) {
        ...
        if($('#title').val().length == 0){
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/update_interview_survey_do';?>' ,
                success: function (data) {
    ...
    $('#question_butt').click(function(e) {
        ...
        if($('#question').val().length == 0){
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/add_interview_survey_question_do';?>' ,
                success: function (data) {
    ...
    $('#update_question_butt').click(function(e) {
        ...
        if($('#question_u').val().length == 0){
            ...
            var frm = $('#interview_survey_question_update');
            //frm.submit();
            $('#update_question_butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'career/update_interview_survey_question_do';?>' ,
                success: function (data) {

                    $("#interview_survey_question_update")[0].reset();
    ...
    function delete_question(id, title){
        ...
        $.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                $.ajax({
                    url: "<?php echo site_url('/');?>career/delete_interview_survey_question_do/"+id+"/",
                    success: function(data) {
                        reload_questions();
    ...
    function reload_questions(){
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo site_url('/').'career/reload_interview_questions/'.$survey_id; ?>' ,
            success: function (data) {
