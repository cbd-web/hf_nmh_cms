			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Testimonial</h2>
						<div class="box-icon">
					...
					<div class="box-content">
							...
							<form id="testimonial-add" name="testimonial-add" method="post" action="<?php echo site_url('/');?>admin/add_testimonial_do" class="form-horizontal">
                             <fieldset>
										  ...
										  <?php echo $this->admin_model->get_testimonial_lang_option(); ?>
										  
                                          <div class="control-group">
                                            <label class="control-label" for="slug">Reference</label>
                                            <div class="controls">
                                          ...
                                          <div class="control-group" id="redactor_content_msg">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <textarea id="redactor_content" class="redactor_content" name="testimonial" style="display:block"></textarea>
                                                </div>
                                           </div>
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Testimonial</button>
