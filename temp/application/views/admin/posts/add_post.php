			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	  	<p>
							<form id="page-update" name="page-update" method="post" action="<?php echo site_url('/');?>admin/add_post_do" class="form-horizontal">
                             <fieldset>
    
                                          <div class="control-group">
                                            <label class="control-label" for="title">Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Post title" value="">
                                            </div>
                                          </div>
                             			  <div class="control-group">
								 ...
								 <div class="control-group">
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Post</button>
