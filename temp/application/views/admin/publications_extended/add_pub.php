			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	  	<p>
							<form id="pub-add" name="pub-add" method="post" action="<?php echo site_url('/');?>publication_extended/add_publication_do" class="form-horizontal">
                             <fieldset>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="heading" name="heading" placeholder="Publication Heading" value="">
                                            </div>
                                          </div>
                             			  <div class="control-group">
...
/*		}else if($('#redactor_content').val() == 0){
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'publication_extended/add_publication_do';?>' ,
