...
<body>
		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
                    ...
                    <li>
						Update Accommodation: <?php echo $title;?>
					</li>
				</ul>
				<hr>
			</div>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span> Update Accommodation: <?php echo $title;?></h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="accommodation-update" name="accommodation-update" method="post" action="<?php echo site_url('/');?>itinerary/update_accommodation_do" class="form-horizontal">
                             <fieldset>
								<input type="hidden" name="id" value="<?php if(isset($accommodation_id)){echo $accommodation_id;}?>">
								...
								<input type="hidden" name="status" id="status"  value="<?php if(isset($status)){echo $status;}?>">
								  ...
								  <div class="control-group">
									...
									<div class="controls">
											<input type="text" class="span6" id="title" name="title" placeholder="Accommodation title" value="<?php if(isset($title)){echo $title;}?>">
									</div>
								  </div>
								  ...
								  <div class="control-group">
									...
									<div class="controls">
										<select name="type">
											...
											<?php echo $this->itinerary_model->get_acc_type_select($type_id); ?>
										</select>
									</div>
								  </div>						  
								  ...
								  <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" id="phone" name="phone" placeholder="Phone Number" value="<?php if(isset($phone)){echo $phone;}?>">
									</div>
								  </div>								  
								  ...
								  <div class="control-group">
									...
									<div class="controls">
										<input class="span6" id="appendedInputButtons1" type="text" name="destination" placeholder="Search Destination..." value="<?php if(isset($destination)){echo $destination;}?>">
									</div>
								  </div>
								  ...
								  <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Update Accommodation</button>
                ...
                <div class="box span6">
					...
					<div class="box-content">
                         ...
                         <div id="gallery_images">   
                            <?php $this->itinerary_model->load_images_update('accommodation', $accommodation_id);?>
                        </div>
	...
	function submit_form(){
		...
		var frm = $('#accommodation-update');
		//frm.submit();
		$('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
		$.ajax({
			type: 'post',
			data: frm.serialize(),
			url: '<?php echo site_url('/').'itinerary/update_accommodation_do';?>' ,
			success: function (data) {
				 $('#autosave').val('true');
				 $('#result_msg').html(data);
				 $('#butt').html('Update Accommodation');
	...
	window.onbeforeunload = function() {		 
		 if($('#autosave').val() == 'false'){
			return 'The accommodation has not been saved.';
		 }
	};
	...
	$(function() {
		...
		<?php //$info = $this->itinerary_model->get_images('accommodation', $accommodation_id); ?>
		...
		$("#uploader").pluploadQueue({
			...
			chunk_size : '1mb',
			unique_names : true,
			multipart_params: {type_id : '<?php echo $accommodation_id; ?>',type : 'accommodation'},
	...
	function load_images(){
		  ...
		  $.ajax({
			cache: false,
			method: "post",  
			url: "<?php echo site_url('/');?>itinerary/load_images_update/accommodation/<?php echo $accommodation_id; ?>/<?php echo rand(0,9999);?>",
			success: function(data) {
	...
	function update_image(id){
			...
			$('#modal-img-update').bind('show', function() {
				  ...
				  $.ajax({
					url: "<?php echo site_url('/');?>itinerary/update_image/"+id+"/",
					success: function(data) {
