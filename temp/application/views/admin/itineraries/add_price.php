...
<body>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Itinerary Price:</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="add-price" name="add-price" method="post" action="<?php echo site_url('/');?>itinerary/add_price_do" class="form-horizontal">
							...
							<input name="itinerary_id" type="hidden" value="<?php echo $itinerary_id; ?>">
                             <fieldset>
								  ...
								  <div class="control-group">
									...
									<div class="controls">
											<input type="text" class="span6" id="title" name="title" placeholder="Tour title" value="">
									</div>
								  </div>
								  ...
								  <div class="control-group">
									...
									<div class="controls">
											<input type="text" class="span6" id="h_price" name="h_price" placeholder="Insert In Season Price" value="">
									</div>
								  </div>
								  ...
								  <div class="control-group">
									...
									<div class="controls">
											<input type="text" class="span6" id="l_price" name="l_price" placeholder="Insert Off Season Price" value="">
									</div>
								  </div>
								  
								  <div id="result_msg"></div>
								  <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Price</button>
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'itinerary/add_price_do'; ?>' ,
