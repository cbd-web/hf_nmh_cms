...
<body>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Chart</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="add-chart" name="add-chart" method="post" action="<?php echo site_url('/');?>admin/add_chart_do" class="form-horizontal">
                             <fieldset>
    
                                          <div class="control-group">
                                            <label class="control-label" for="title">Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Chart title" value="">
                                            </div>
                                          </div>
                             			  ...
                             			  <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="heading" name="heading" placeholder="Chart Heading" value="">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="slug" name="slug" placeholder="Chart URL Slug eg: /misc-chart" value="">  
                                            </div>
                                          </div>
											...
											<div class="controls">
												<select name="category">
													<?php echo $this->chart_model->get_category_option_list(); ?>
												</select> 
											</div>
										  </div>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="x_title" name="x_title" placeholder="X-Axis Title" value="">
                                            </div>
                                          </div>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="y_title" name="y_title" placeholder="Y-Axis Title" value="">
                                            </div>
                                          </div>										  										  
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input name="sequence" type="text" class="span1" id="sequence" value="0" size="3" maxlength="3">  
                                            </div>
                                 		  </div>
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Chart</button>
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'admin/add_chart_do';?>' ,
