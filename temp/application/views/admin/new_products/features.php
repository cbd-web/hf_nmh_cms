		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>admin/products">Features</a> <span class="divider">/</span>
					</li>
					<li>
						<a href="#">Features</a>
					</li>					
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>All Product Features</h2>
						<div class="box-icon">
							<a href="#" class="btn-close"><i class="icon-remove"></i></a>
						</div>
					</div>
					<div class="box-content" id="curr_cats">
                  	  	<?php $this->product_model->get_all_features();?>
                ...
                <div class="box span4 noMargin" onTablet="span12" onDesktop="span4">
					...
					<div class="box-content">
					 <div class="clearfix" style="height:20px;"></div> 
                       <form id="feature_add" name="feature_add" method="post" action="<?php echo site_url('/');?>product/add_feature" class="form-inline">
						   <fieldset>
			...
			$('#modal-feature-delete').bind('show', function() {
				//var id = $(this).data('id'),
					...
					removeBtn.unbind('click').click(function(e) { 
						e.preventDefault();	
						$.ajax({
						  url: "<?php echo site_url('/');?>product/delete_feature/"+id+"/",
						...
						function add_feature(){
							...
							if($('#appendedInputButtons').val().length == 0){
								...
								$.ajax({
									type: 'post',
									data: frm.serialize(),
									url: '<?php echo site_url('/').'product/add_feature';?>' ,
									success: function (data) {
						...
						function reload_features(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'product/reload_features_all/';?>' ,
									success: function (data) {
						...
						$(document).ready(function() {
							...
							<?php echo $this->product_model->load_feature_typehead();?>
