...
<body>
		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>product/stock_products/">Stock Products</a><span class="divider">/</span>
					</li>
                    <li>
						Update Stock Product: <?php echo $title;?>
					</li>
				</ul>
				<hr>
			</div>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span> Update Stock Product: <?php echo $title;?></h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="product-update" name="product-update" method="post" action="<?php echo site_url('/');?>product/update_stock_product_do" class="form-horizontal">
                             <fieldset>
    										<input type="hidden" name="stock_id"  value="<?php if(isset($stock_id)){echo $stock_id;}?>">
										  ...
										  <div class="control-group">
                                            ...
                                            <div class="controls">
												...
												<option value="0">Select a Product</option>
													<?php echo $this->product_model->get_product_list($product_id); ?>
												</select>
                                            </div>
                                          </div>
                                         ...
                                         <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="price" name="price" placeholder="Price"  value="<?php if(isset($price)){echo $price;}?>">
                                            </div>
                                          </div>
										  ...
										  <button type="submit" class="btn btn-inverse btn pull-right" id="butt" style="margin-right:10px;">Update Stock Product</button>
				...
				<div class="box span4">
					...
					<div class="box-content">
						...
						<?php $this->admin_model->get_featured_image('stock', $stock_id);?>
	...
	$('#butt').click(function(e) {
		...
		if($('#title').val().length == 0){
				...
				$('#title').popover({  delay: { show: 100, hide: 3000 },placement:"top",html: true,trigger: "manual", title:"Title Required", content:"Please supply us with a stock product title"});
				$('#title').popover('show');
				$('#title').focus();
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'product/update_stock_product_do';?>' ,
	...
	window.onbeforeunload = function() {
		 ...
		 if($('#autosave').val() == 'false'){
			return 'The stock product has not been saved.';
