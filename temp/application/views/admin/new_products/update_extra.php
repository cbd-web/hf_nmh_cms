		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>product/extras/">Product Extras</a><span class="divider">/</span>
					</li>
                    <li>
						Update Product Extra: <?php echo $title;?>
					</li>
				</ul>
				<hr>
			</div>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span> Update Product Extra: <?php echo $title;?></h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="extra-update" name="extra-update" method="post" action="<?php echo site_url('/');?>product/update_extra_do" class="form-horizontal">
                             <fieldset>
    										<input type="hidden" name="extra_id"  value="<?php if(isset($extra_id)){echo $extra_id;}?>">
                                            <input type="hidden" name="autosave" id="autosave"  value="true">

                                          <div class="control-group">
                                            <label class="control-label" for="title">Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Extra title" value="<?php if(isset($title)){echo $title;}?>">
                                            </div>
                                          </div>
                                         ...
                                         <div class="control-group">
										  ...
										  <button type="submit" class="btn btn-inverse btn pull-right" id="butt" style="margin-right:10px;">Update Product Extra</button>
                ...
                <div class="box span4">
					...
					<div class="box-content">
						...
						<?php $this->admin_model->get_featured_image('product_extra', $extra_id);?>
...
//				$('#redactor_content_msg').focus();		
	...
	function submit_form(){
			...
			var frm = $('#extra-update');
			//frm.submit();
			$('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'product/update_extra_do';?>' ,
				success: function (data) {
					 $('#autosave').val('true');
					 $('#result_msg').html(data);
					 $('#butt').html('Update Product Extra');
