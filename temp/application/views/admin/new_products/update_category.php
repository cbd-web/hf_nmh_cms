		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>product/categories/">Categories</a><span class="divider">/</span>
					</li>
                    <li>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	  	<p>
							<form id="cat-update" name="cat-update" method="post" action="<?php echo site_url('/');?>product/update_categoru_do" class="form-horizontal">
                             <fieldset>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="slug" name="slug" placeholder="Category URL Slug eg: /about-us" value="<?php if(isset($cat_slug)){echo $cat_slug;}?>">
                                            </div>
                                          </div>
                ...
                <div class="box span4">
					...
					<div class="box-content">
						...
						<?php $this->admin_model->get_featured_image('product_cat', $cat_id);?>
...
//				$('#redactor_content_msg').focus();		
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'product/update_category_do';?>' ,
