			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content" id="curr_cats">
                  	  	<?php $this->admin_model->get_all_manufacturers();?>
			...
			$('#modal-manufacturer-delete').bind('show', function() {
				//var id = $(this).data('id'),
					...
					removeBtn.unbind('click').click(function(e) { 
						e.preventDefault();	
						$.ajax({
						  url: "<?php echo site_url('/');?>admin/delete_manufacturer/"+id+"/",
						...
						function add_manufacturer(){
							...
							if($('#appendedInputButtons').val().length == 0){
								...
								$.ajax({
									type: 'post',
									data: frm.serialize(),
									url: '<?php echo site_url('/').'admin/add_manufacturer';?>' ,
									success: function (data) {
						...
						function reload_manufacturer(){
								...
								$.ajax({
									type: 'get',
									url: '<?php echo site_url('/').'admin/reload_manufacturer_all/';?>' ,
									success: function (data) {
						...
						$(document).ready(function() {
							...
							<?php echo $this->admin_model->load_manufacturer_typehead();?>
