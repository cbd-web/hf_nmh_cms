			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					...
					<div class="box-content">
                  	  	<p>
							<form id="product-update" name="product-update" method="post" action="<?php echo site_url('/');?>admin/add_product_do" class="form-horizontal">
                             <fieldset>
										  ...
										  <div class="control-group">
                                            ...
                                            <div class="controls">
												...
												<option value="0">Select Category</option>
													<?php echo $this->admin_model->get_all_product_categories(0); ?>
												</select>
                                            </div>
                                          </div>
...
//			
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'admin/add_product_do';?>' ,
