...
<body>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span> Update Advert: <?php echo $title; ?></h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="advert-update" name="advert-update" method="post" action="<?php echo site_url('/');?>advert/update_advert_do" class="form-horizontal">
                             <fieldset>
                                          ...
                                          <div class="control-group" id="redactor_content_msg">
                                                <label class="control-label" for="redactor_content">Advert Body:</label>
                                                <div class="controls">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                            		...
                                            		<span class="help-block" style="font-size:11px">Set the sequence of the advert</span>
                                            </div>
                                 		  </div>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="url" name="url" placeholder="Page title" value="<?php if(isset($url)){echo $url;}?>">
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Update Advert</button> 
                               </fieldset> 
                             </form>
		             	</p>                                         
                  </div>
				...
				<div class="box span4">
					...
					<div class="box-content">
						<p>
							...
							$data['type_id'] = $advert_id;
							$data['type'] = 'advert';

							$this->load->view('admin/adverts/inc/branches_inc', $data);
                 ...
                 <div class="box span4">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Advert Sidebar</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<div class="alert">
                        This is the secondary smaller advert column. Please select what component you would like to display.
                        </div>
                        <p>
                ...
                <div class="box span4">
					...
					<div class="box-content">
						...
						<?php $this->admin_model->get_featured_image('advert', $advert_id);?>
                ...
                <div class="box span4">
                    ...
                    <div class="box-content">
                        <p>
                            <?php $this->load->view('admin/adverts/inc/categories_inc');?>
                        </p>
                    </div>
                </div>
                ...
                <div class="box span4">
                    <div class="box-header">
                        <h2><i class="icon-th"></i><span class="break"></span>Pages</h2>
                        <div class="box-icon">
                            <a href="#" class="btn-close"><i class="icon-remove"></i></a>
                        </div>
                    </div>
                    <div class="box-content">
                        <p>
							...
							$this->load->view('admin/adverts/inc/pages_inc', $data);
	...
	/*		}else if($('#redactor_content').val() == 0){
		...
		$('#advert-update :input').change(function() {
	...
	function submit_form(){
			...
			var frm = $('#advert-update'), content = $('#redactor_content').text();
			...
			$.ajax({
				...
				data: frm.serialize(),
				url: '<?php echo site_url('/').'advert/update_advert_do';?>' ,
				success: function (dataresult) {
					 $('#autosave').val('true');
					 $('#result_msg').html(dataresult);
					 $('#butt').html('Update Advert');
	...
	window.onbeforeunload = function() {
		 ...
		 if($('#autosave').val() == 'false'){
			return 'The advert has not been saved.'; 
