		...
		<div class="row-fluid">
			...
			<div>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo site_url('/');?>admin/adverts/">Adverts</a><span class="divider">/</span>
					</li>
                    <li>
						Add New Advert
					</li>
			...
			<div class="row-fluid sortable">
				...
				<div class="box span8">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Advert</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="advert-update" name="advert-update" method="post" action="<?php echo site_url('/');?>advert/add_advert_do" class="form-horizontal">
                             <fieldset>
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="url" name="url" placeholder="Page title" value="">
                                            </div>
                                          </div>
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Advert</button>
...
/*		}else if($('#redactor_content').val() == 0){
	...
	function submit_form(){
			...
			var frm = $('#advert-update');
			//frm.submit();
			$('#butt').html('<img src="<?php echo base_url('/').'admin_src/img/loading_white.gif';?>" /> Working...');
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'advert/add_advert_do';?>' ,
				success: function (data) {
					
					 $('#result_msg').html(data);
					 $('#butt').html('Add Advert');
