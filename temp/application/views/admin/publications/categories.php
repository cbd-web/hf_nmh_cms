            ...
            <div class="row-fluid sortable">
                ...
                <div class="box span8">
                    ...
                    <div class="box-content" id="curr_cats">
                        <?php $this->publication_model->get_all_categories($id);?>
                ...
                <div class="box span4 noMargin" onTablet="span12" onDesktop="span4">
                    ...
                    <div class="box-content">
                        ...
                        <form id="category_add" name="category_add" method="post" action="<?php echo site_url('/');?>publication/add_category_do" class="form-inline">
                            <fieldset>
                                <div class="span12">
                                    ...
                                    <div id="curr_parents">
                                        ...
                                        <?php echo $this->publication_model->get_category_list(); ?>
...
<script type="text/javascript">
    function delete_category(id){
        ...
        $('#modal-category-delete').bind('show', function() {
            ...
            removeBtn.unbind('click').click(function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php echo site_url('/');?>publication/delete_category/"+id+"/",
    ...
    function add_category(){
        ...
        if($('#appendedInputButtons').val().length == 0){
            ...
            $.ajax({
                type: 'post',
                data: frm.serialize(),
                url: '<?php echo site_url('/').'publication/add_category';?>' ,
                success: function (data) {
    ...
    function reload_category(){
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo site_url('/').'publication/reload_category_all/'.$id; ?>' ,
            success: function (data) {
