			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					<div class="box-header">
						<h2><i class="icon-th"></i><span class="break"></span>Add New Project</h2>
						<div class="box-icon">
					...
					<div class="box-content">
                  	  	<p>
							<form id="project-update" name="project-update" method="post" action="<?php echo site_url('/');?>project/add_project_do" class="form-horizontal">
                             <fieldset>
    
                                          <div class="control-group">
                                            <label class="control-label" for="title">Title</label>
                                            <div class="controls">
                                                    <input type="text" class="span6" id="title" name="title" placeholder="Project title" value="">
                                            </div>
                                          </div>
                             			  <div class="control-group">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="span6" id="slug" name="slug" placeholder="Project URL Slug eg: /about-us" value="">  
                                            </div>
                                          </div>
											 ...
											 <div class="controls">
												 <select name="client_id">
													 <option value="0">Select a Client</option>
												 	 <?php echo $this->project_model->get_project_clients(); ?>
												 </select>
											 </div>
										 </div>
										 ...
										 <div class="control-group">
											 ...
											 <div class="controls">
												 <input type="text" class="span6" id="video" name="video" placeholder="Project Video" value="">
											 </div>
										 </div>

                                          <div class="control-group">
                                                    <label class="control-label" for="pdate">Publish date</label>
                                                    <div class="controls">
                                                             <div class="input-append date" id="pdate" data-date="1985-10-19" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                                              <input type="text"  name="pub_date" id="pub_date" value="<?php if (isset($review)){echo date('Y-m-d',strtotime($review));}else{ echo date('Y-m-d');}?>" readonly>
                                          ...
                                          <button type="submit" class="btn btn-inverse btn pull-right" id="butt">Add Project</button>
...
//			
	...
	function submit_form(){
			...
			$.ajax({
				type: 'post',
				data: frm.serialize(),
				url: '<?php echo site_url('/').'project/add_project_do';?>' ,
				success: function (data) {
					
					 $('#result_msg').html(data);
					 $('#butt').html('Add Project');
